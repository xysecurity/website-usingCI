...
class EditeventForm extends CI_Controller {
...
session_start();
        ...
        $this->load->view('listevent(agent)');
    ...
    if($_FILES['img1']['error'] > 0){
      ...
      $this->db->where('Nombre',$_POST['eventname']);
      $this->db->update('event',$data);
      echo "Edit successfully, Event name is ".$_POST['Nombre'];

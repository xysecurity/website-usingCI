...
<div id="wrapper" class="main">
	...
	<div class="container" style="background:#D7D7D7;">
			<!-- <form id="update" action="<?php echo $this->config->item('base_url'); ?>php/updateevent.php" method="post" enctype="multipart/form-data"> -->
				
				<?php 
				$attributes = array('name' => 'update', 'id' => 'update','enctype'=>'multipart/form-data');


				echo form_open('editeventForm',$attributes); ?>
				<div class="row">
				...
				<div class="col-md-4">
					...
					<img name="showimg" id="showimg" src="<?php echo $this->config->item('base_url'); ?><?php echo $row['img']; ?>" width="120px" height="120px"></div>
			<div class="row offset-2">

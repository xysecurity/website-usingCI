...
<div id="header" style="height:200px;">
  ...
  <div style="position:relative;top:50px;left:200px">
   ...
   <li><a href="HomeAge">Inicil</a></li>
    ...
    <li><a class="active" href="listfundationagent">Listade Fundaciones</a></li>
...
<div class="col-md-8 offset-4">
	...
	<div class="col-md-2" align="center">
		...
		<form action="<?php echo $this->config->item('base_url'); ?>php/preto.php" method="post" name="choose" id="choose">

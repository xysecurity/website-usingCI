...
<div id="header" style="height:200px;">
  ...
  <div style="position:relative;top:50px;left:200px">
    ...
    <li><a class="active" href="listeventfundation">Inicil</a></li>
    <li><a href="profilefundation">Fundation</a></li>
...
<div class="col-md-12" align="center">
	...
	<div class="col-md-2" align="center">
		...
		<form action="<?php echo $this->config->item('base_url'); ?>php/chooseevent(funda).php" method="post" name="choose" id="choose">
